                ...
                <div class="col-md-6 book-left">
                    ...
                    <div class="book-left-form">
                        <form>
                            ...
                            <script type="text/javascript">$("#flightID").val(flightID);</script>
                            <p>出发日期</p>
                            <input class="inputClass" type="text" name="srcDate" id="srcDate" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#srcDate").val(srcDate);</script>
                            <p>到达日期</p>
                            <input class="inputClass" type="text" name="dstDate" id="dstDate" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#dstDate").val(dstDate);</script>
                            <p>价格</p>
                            <input class="inputClass" type="text" name="price" id="price" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#price").val(price);</script>
                            <p>出发时间</p>
                            <input class="inputClass" type="text" name="srcTime" id="srcTime" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#srcTime").val(srcTime);</script>
                            <p>到达时间</p>
                            <input class="inputClass" type="text" name="dstTime" id="dstTime" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#dstTime").val(dstTime);</script>
                            <p>航空公司</p>
                            <input class="inputClass" type="text" name="company" id="company" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#company").val(company);</script>
                            <p>出发地</p>
                            <input class="inputClass" type="text" name="srcPlace" id="srcPlace" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#srcPlace").val(srcPlace);</script>
                            <p>到达地</p>
                            <input class="inputClass" type="text" name="dstPlace" id="dstPlace" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#dstPlace").val(dstPlace);</script>
                            <p>出发机场</p>
                            <input class="inputClass" type="text" name="srcAirport" id="srcAirport" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#srcAirport").val(srcAirport);</script>
                            <p>到达机场</p>
                            <input class="inputClass" type="text" name="dstAirport" id="dstAirport" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}">
                            <script type="text/javascript">$("#dstAirport").val(dstAirport);</script>
                            <label for="checkbox">
                                <input type="button" id="modify_button" value="确认修改">
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    $("#modify_button").click(function(){
        ...
        if(confirm("您确定要修改此记录吗？")){
            var url="flight_file_servlet_action?action=modify_record&flightID="+flightID+"&srcDate="+srcDate+"&dstDate="+dstDate+
            "&price="+price+"&srcTime="+srcTime+"&dstTime="+dstTime+"&company="+company+"&srcPlace="+srcPlace+"&dstPlace="+srcAirport+"&srcAirport="+dstPlace+"&dstAirport="+dstAirport;
            $.ajax({
                type:"post",
                url:url,
                dataType:'json',
